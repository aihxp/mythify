...
- **Quick wins** (highest value per effort; act now): completed SEC-001 and ERR-004. Next small slices: SEC-003, SEC-006, ERR-002, TEST-002, and DOC-002 after confirming each cited behavior still holds.
...
- **Backlog** (Low; batch): SEC-003, SEC-006, ERR-002, PERF-001, TEST-002, DOC-002.
