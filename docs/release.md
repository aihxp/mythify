...
Current release target: `v3.6.10`.
...
- Version: `3.6.10`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.10.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.10.tgz`
...
```bash
gh release create v3.6.10 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.10.tgz \
  --title "Mythify v3.6.10" \
  --notes-file /tmp/mythify-v3-6-10-release-notes.md
```
...
(`mythify-mcp-3.6.10.tgz`) rather than publishing an npm package to the GitHub
