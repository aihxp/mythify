...
Current release target: `v3.6.51`.
...
- Version: `3.6.51`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.51.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.51.tgz`
...
```bash
gh release create v3.6.51 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.51.tgz \
  --title "Mythify v3.6.51" \
  --notes-file /tmp/mythify-v3-6-51-release-notes.md
```
...
(`mythify-mcp-3.6.51.tgz`) rather than publishing an npm package to the GitHub
