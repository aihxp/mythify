...
Current release target: `v3.6.42`.
...
- Version: `3.6.42`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.42.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.42.tgz`
...
```bash
gh release create v3.6.42 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.42.tgz \
  --title "Mythify v3.6.42" \
  --notes-file /tmp/mythify-v3-6-42-release-notes.md
```
...
(`mythify-mcp-3.6.42.tgz`) rather than publishing an npm package to the GitHub
