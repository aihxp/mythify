...
- Version: `3.6.8`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.8.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.8.tgz`
...
gh release create v3.6.8 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.8.tgz \
  --title "Mythify v3.6.8" \
  --notes-file /tmp/mythify-v3-6-8-release-notes.md
```
...
(`mythify-mcp-3.6.8.tgz`) rather than publishing an npm package to the GitHub
