...
Current release target: `v3.6.36`.
...
- Version: `3.6.36`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.36.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.36.tgz`
...
```bash
gh release create v3.6.36 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.36.tgz \
  --title "Mythify v3.6.36" \
...
(`mythify-mcp-3.6.36.tgz`) rather than publishing an npm package to the GitHub
