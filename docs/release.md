...
- Version: `3.6.7`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.7.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.7.tgz`
...
```bash
gh release create v3.6.7 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.7.tgz \
  --title "Mythify v3.6.7" \
  --notes-file /tmp/mythify-v3-6-7-release-notes.md
```
...
(`mythify-mcp-3.6.7.tgz`) rather than publishing an npm package to the GitHub
