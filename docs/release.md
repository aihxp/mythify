...
Current release target: `v3.6.18`.
...
- Version: `3.6.18`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.18.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.18.tgz`
...
```bash
gh release create v3.6.18 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.18.tgz \
  --title "Mythify v3.6.18" \
  --notes-file /tmp/mythify-v3-6-18-release-notes.md
```
...
(`mythify-mcp-3.6.18.tgz`) rather than publishing an npm package to the GitHub
