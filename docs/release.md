...
Current release target: `v3.6.19`.
...
- Version: `3.6.19`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.19.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.19.tgz`
...
```bash
gh release create v3.6.19 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.19.tgz \
  --title "Mythify v3.6.19" \
  --notes-file /tmp/mythify-v3-6-19-release-notes.md
```
...
(`mythify-mcp-3.6.19.tgz`) rather than publishing an npm package to the GitHub
