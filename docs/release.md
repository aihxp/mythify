...
Current release target: `v3.6.23`.
...
- Version: `3.6.23`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.23.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.23.tgz`
...
```bash
gh release create v3.6.23 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.23.tgz \
  --title "Mythify v3.6.23" \
  --notes-file /tmp/mythify-v3-6-23-release-notes.md
```
...
(`mythify-mcp-3.6.23.tgz`) rather than publishing an npm package to the GitHub
