...
Current release target: `v3.6.49`.
...
- Version: `3.6.49`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.49.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.49.tgz`
...
```bash
gh release create v3.6.49 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.49.tgz \
  --title "Mythify v3.6.49" \
  --notes-file /tmp/mythify-v3-6-49-release-notes.md
```
...
(`mythify-mcp-3.6.49.tgz`) rather than publishing an npm package to the GitHub
