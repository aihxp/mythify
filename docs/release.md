...
Current release target: `v3.6.44`.
...
- Version: `3.6.44`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.44.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.44.tgz`
...
```bash
gh release create v3.6.44 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.44.tgz \
  --title "Mythify v3.6.44" \
  --notes-file /tmp/mythify-v3-6-44-release-notes.md
```
...
(`mythify-mcp-3.6.44.tgz`) rather than publishing an npm package to the GitHub
