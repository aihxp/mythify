...
Current release target: `v3.6.50`.
...
- Version: `3.6.50`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.50.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.50.tgz`
...
```bash
gh release create v3.6.50 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.50.tgz \
  --title "Mythify v3.6.50" \
  --notes-file /tmp/mythify-v3-6-50-release-notes.md
```
...
(`mythify-mcp-3.6.50.tgz`) rather than publishing an npm package to the GitHub
