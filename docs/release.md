...
Current release target: `v3.6.34`.
...
- Version: `3.6.34`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.34.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.34.tgz`
...
```bash
gh release create v3.6.34 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.34.tgz \
  --title "Mythify v3.6.34" \
  --notes-file /tmp/mythify-v3-6-34-release-notes.md
```
...
(`mythify-mcp-3.6.34.tgz`) rather than publishing an npm package to the GitHub
