...
Current release target: `v3.6.37`.
...
- Version: `3.6.37`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.37.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.37.tgz`
...
```bash
gh release create v3.6.37 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.37.tgz \
  --title "Mythify v3.6.37" \
  --notes-file /tmp/mythify-v3-6-36-release-notes.md
```
...
(`mythify-mcp-3.6.37.tgz`) rather than publishing an npm package to the GitHub
