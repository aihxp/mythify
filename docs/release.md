...
Current release target: `v3.6.33`.
...
- Version: `3.6.33`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.33.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.33.tgz`
...
```bash
gh release create v3.6.33 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.33.tgz \
  --title "Mythify v3.6.33" \
  --notes-file /tmp/mythify-v3-6-33-release-notes.md
```
...
(`mythify-mcp-3.6.33.tgz`) rather than publishing an npm package to the GitHub
