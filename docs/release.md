...
- Version: `3.6.1`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.1.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.1.tgz`
...
gh release create v3.6.1 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.1.tgz \
  --title "Mythify v3.6.1" \
  --notes-file /tmp/mythify-v3-6-1-release-notes.md
```
...
(`mythify-mcp-3.6.1.tgz`) rather than publishing an npm package to the GitHub
