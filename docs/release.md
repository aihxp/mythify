...
Current release target: `v3.6.38`.
...
- Version: `3.6.38`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.38.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.38.tgz`
...
```bash
gh release create v3.6.38 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.38.tgz \
  --title "Mythify v3.6.38" \
...
(`mythify-mcp-3.6.38.tgz`) rather than publishing an npm package to the GitHub
