...
- Version: `3.6.9`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.9.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.9.tgz`
...
```bash
gh release create v3.6.9 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.9.tgz \
  --title "Mythify v3.6.9" \
  --notes-file /tmp/mythify-v3-6-9-release-notes.md
```
...
(`mythify-mcp-3.6.9.tgz`) rather than publishing an npm package to the GitHub
