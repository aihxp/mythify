...
Current release target: `v3.6.12`.
...
- Version: `3.6.12`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.12.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.12.tgz`
...
```bash
gh release create v3.6.12 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.12.tgz \
  --title "Mythify v3.6.12" \
  --notes-file /tmp/mythify-v3-6-12-release-notes.md
```
...
(`mythify-mcp-3.6.12.tgz`) rather than publishing an npm package to the GitHub
