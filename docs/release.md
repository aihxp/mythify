...
Current release target: `v3.6.48`.
...
- Version: `3.6.48`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.48.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.48.tgz`
...
```bash
gh release create v3.6.48 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.48.tgz \
  --title "Mythify v3.6.48" \
  --notes-file /tmp/mythify-v3-6-48-release-notes.md
```
...
(`mythify-mcp-3.6.48.tgz`) rather than publishing an npm package to the GitHub
