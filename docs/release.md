...
Current release target: `v3.6.14`.
...
- Version: `3.6.14`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.14.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.14.tgz`
...
```bash
gh release create v3.6.14 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.14.tgz \
  --title "Mythify v3.6.14" \
  --notes-file /tmp/mythify-v3-6-14-release-notes.md
```
...
(`mythify-mcp-3.6.14.tgz`) rather than publishing an npm package to the GitHub
