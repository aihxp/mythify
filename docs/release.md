...
Current release target: `v3.6.25`.
...
- Version: `3.6.25`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.25.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.25.tgz`
...
```bash
gh release create v3.6.25 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.25.tgz \
  --title "Mythify v3.6.25" \
  --notes-file /tmp/mythify-v3-6-25-release-notes.md
```
...
(`mythify-mcp-3.6.25.tgz`) rather than publishing an npm package to the GitHub
