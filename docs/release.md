...
Current release target: `v3.6.31`.
...
- Version: `3.6.31`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.31.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.31.tgz`
...
```bash
gh release create v3.6.31 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.31.tgz \
  --title "Mythify v3.6.31" \
  --notes-file /tmp/mythify-v3-6-31-release-notes.md
```
...
(`mythify-mcp-3.6.31.tgz`) rather than publishing an npm package to the GitHub
