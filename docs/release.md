...
Current release target: `v3.6.22`.
...
- Version: `3.6.22`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.22.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.22.tgz`
...
```bash
gh release create v3.6.22 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.22.tgz \
  --title "Mythify v3.6.22" \
  --notes-file /tmp/mythify-v3-6-22-release-notes.md
```
...
(`mythify-mcp-3.6.22.tgz`) rather than publishing an npm package to the GitHub
