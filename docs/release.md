...
Current release target: `v3.6.43`.
...
- Version: `3.6.43`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.43.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.43.tgz`
...
```bash
gh release create v3.6.43 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.43.tgz \
  --title "Mythify v3.6.43" \
  --notes-file /tmp/mythify-v3-6-43-release-notes.md
```
...
(`mythify-mcp-3.6.43.tgz`) rather than publishing an npm package to the GitHub
