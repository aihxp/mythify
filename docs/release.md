...
Current release target: `v3.6.11`.
...
- Version: `3.6.11`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.11.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.11.tgz`
...
```bash
gh release create v3.6.11 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.11.tgz \
  --title "Mythify v3.6.11" \
  --notes-file /tmp/mythify-v3-6-11-release-notes.md
```
...
(`mythify-mcp-3.6.11.tgz`) rather than publishing an npm package to the GitHub
