...
Current release target: `v3.6.46`.
...
- Version: `3.6.46`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.46.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.46.tgz`
...
```bash
gh release create v3.6.46 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.46.tgz \
  --title "Mythify v3.6.46" \
  --notes-file /tmp/mythify-v3-6-46-release-notes.md
```
...
(`mythify-mcp-3.6.46.tgz`) rather than publishing an npm package to the GitHub
