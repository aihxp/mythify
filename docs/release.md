...
Current release target: `v3.6.35`.
...
- Version: `3.6.35`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.35.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.35.tgz`
...
```bash
gh release create v3.6.35 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.35.tgz \
  --title "Mythify v3.6.35" \
  --notes-file /tmp/mythify-v3-6-35-release-notes.md
```
...
(`mythify-mcp-3.6.35.tgz`) rather than publishing an npm package to the GitHub
