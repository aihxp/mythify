...
Current release target: `v3.6.16`.
...
- Version: `3.6.16`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.16.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.16.tgz`
...
```bash
gh release create v3.6.16 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.16.tgz \
  --title "Mythify v3.6.16" \
  --notes-file /tmp/mythify-v3-6-16-release-notes.md
```
...
(`mythify-mcp-3.6.16.tgz`) rather than publishing an npm package to the GitHub
