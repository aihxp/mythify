...
Current release target: `v3.6.13`.
...
- Version: `3.6.13`
- Node runtime: `>=18`
- Package artifact: `mcp-server/mythify-mcp-3.6.13.tgz`
...
- `dist/mythify.skill`
- `mcp-server/mythify-mcp-3.6.13.tgz`
...
```bash
gh release create v3.6.13 \
  dist/mythify.skill \
  mcp-server/mythify-mcp-3.6.13.tgz \
  --title "Mythify v3.6.13" \
  --notes-file /tmp/mythify-v3-6-13-release-notes.md
```
...
(`mythify-mcp-3.6.13.tgz`) rather than publishing an npm package to the GitHub
