...
(current 1.x) and `zod` (4.x). package.json: name `mythify-mcp`, version `3.6.12`,
...
This is Mythify v3.6.12. Fanout was added in 2.1.0; 2.2.0 added local
...
refreshes the roadmap release status after the DOC-001 audit slice.
The CLI reports 3.6.12 through `--version`; the MCP server reads `package.json`
