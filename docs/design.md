...
(current 1.x) and `zod` (4.x). package.json: name `mythify-mcp`, version `3.6.42`,
...
This is Mythify v3.6.42. Fanout was added in 2.1.0; 2.2.0 added local
...
timeline, and phase view helpers into a direct-import CLI helper module.
The CLI reports 3.6.42 through `--version`; the MCP server reads `package.json`
