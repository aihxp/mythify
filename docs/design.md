...
(current 1.x) and `zod` (4.x). package.json: name `mythify-mcp`, version `3.6.34`,
...
This is Mythify v3.6.34. Fanout was added in 2.1.0; 2.2.0 added local
...
into a direct-import MCP helper module.
The CLI reports 3.6.34 through `--version`; the MCP server reads `package.json`
