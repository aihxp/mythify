...
(current 1.x) and `zod` (4.x). package.json: name `mythify-mcp`, version `3.6.13`,
...
This is Mythify v3.6.13. Fanout was added in 2.1.0; 2.2.0 added local
...
clarifies README architecture wording for the DOC-002 audit slice.
The CLI reports 3.6.13 through `--version`; the MCP server reads `package.json`
